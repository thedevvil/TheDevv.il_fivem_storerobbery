...
Config.Safes = {
    ...
    [5] = {vector3(31.22, -1339.28, 29.5), type = "keypad", robbed = false, camId = 8},
    ...
    [8] = {vector3(381.03, 332.54, 103.57), type = "keypad", robbed = false, camId = 11},
    ...
    [11] = {vector3(-3048.7, 588.47, 7.91), type = "keypad", robbed = false, camId = 14},
    [12] = {vector3(-3249.7, 1007.38, 12.83), type = "keypad", robbed = false, camId = 15},
    [13] = {vector3(543.78, 2662.51, 42.16), type = "keypad", robbed = false, camId = 16},
    [14] = {vector3(1169.31, 2717.79, 37.15), type = "padlock", robbed = false, camId = 17},
    [15] = {vector3(2674.22, 3289.22, 55.24), type = "keypad", robbed = false, camId = 18},
    [16] = {vector3(1961.82, 3750.37, 32.34), type = "keypad", robbed = false, camId = 19},
    [17] = {vector3(1737.47, 6419.48, 35.04), type = "keypad", robbed = false, camId = 20},
    [18] = {vector3(-168.40, 6318.80, 30.58), type = "padlock", robbed = false, camId = 27},
    [19] = {vector3(170.94, 6642.53, 31.7), type = "keypad", robbed = false, camId = 30},
}
